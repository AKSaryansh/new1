...
function SpecialitySkin() {
  ...
  return (
    ...
    <div style={{ padding: '50px 15px', backgroundColor: '#f4eee1', borderRadius: '10px',marginTop:"160px" }}>
  <h1 style={{ textAlign: 'center', color: '#6B4226', fontSize:"1.5rem" }}>Skin Care through Ayurveda</h1>
  <p style={{ textAlign: 'center', fontStyle: 'italic' ,fontSize:"0.8rem"}}>Nurturing Skin Health with the Gentle Touch of Sai Ayurveda</p>
  <div className="container mt-5">
    <div className="row">
      <div className="col-md-6 mb-4">
        <div style={{ backgroundColor:"white",  padding: '15px', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
